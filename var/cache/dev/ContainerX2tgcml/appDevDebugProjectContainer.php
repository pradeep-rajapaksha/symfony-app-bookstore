...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->services = [];
        $this->normalizedIds = [
            'appbundle\\datafixtures\\orm\\loadfixturedata' => 'AppBundle\\DataFixtures\\ORM\\LoadFixtureData',
            'bookstore\\defaultbundle\\controller\\securitycontroller' => 'Bookstore\\DefaultBundle\\Controller\\SecurityController',
        ...
        $this->fileMap = [
            'AppBundle\\DataFixtures\\ORM\\LoadFixtureData' => 'getLoadFixtureDataService.php',
            'Bookstore\\DefaultBundle\\Controller\\SecurityController' => 'getSecurityControllerService.php',
        ...
        $this->privates = [
            ...
            'AppBundle\\DataFixtures\\ORM\\LoadFixtureData' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('m4wZ3eo77a', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vR36Tp48t0', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('G0wBdlrL59', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ux+2hLEUoY', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ve+NbXaSHs', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('3d0c07d761fabf4df865724eed932685a81dedc3'))) && false ?: '_'}, '/_fragment');
    }
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('main', '/store/logout', 'logout', '_csrf_token', NULL, NULL);
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath(($this->targetDirs[3].'/src/Bookstore/DefaultBundle/Resources/views'), 'BookstoreDefault');
        $instance->addPath(($this->targetDirs[3].'/src/Bookstore/DefaultBundle/Resources/views'), '!BookstoreDefault');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('3d0c07d761fabf4df865724eed932685a81dedc3');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'BookstoreDefaultBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Bookstore/DefaultBundle'),
                    'namespace' => 'Bookstore\\DefaultBundle',
                ],
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'BookstoreDefaultBundle' => 'Bookstore\\DefaultBundle\\BookstoreDefaultBundle',
            ...
            'kernel.secret' => '3d0c07d761fabf4df865724eed932685a81dedc3',
