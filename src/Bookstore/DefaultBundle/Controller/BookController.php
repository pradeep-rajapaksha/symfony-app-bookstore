...
use Bookstore\DefaultBundle\Form\BookType;
...
class BookController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BookstoreDefaultBundle:Book')->findAll();
     ...
     * @Method("POST")
     * @Template("BookstoreDefaultBundle:Book:new.html.twig")
     */
    ...
    */
     ...
     * @Method("PUT")
     * @Template("BookstoreDefaultBundle:Book:edit.html.twig")
     */
