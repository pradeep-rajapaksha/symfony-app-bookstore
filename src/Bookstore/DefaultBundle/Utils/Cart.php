...
namespace Bookstore\DefaultBundle\Utils;
 ...
 * Class Cart
 *
 * @package Bookstore\DefaultBundle\Utils
 */
class Cart implements \ArrayAccess
{
    /** book category id */
    CONST CATEGORY_CHILD_BOOK = 1;
     ...
     * Get all Items
     *
     * @return \Bookstore\DefaultBundle\Utils\CartItem[] An array of Items,  if no Items then an empty array
     */
     ...
     *
     * @param \Bookstore\DefaultBundle\Utils\CartItem $newItem The Item to add
     */
     ...
     *
     * @param \Bookstore\DefaultBundle\Utils\CartItem $item
     */
